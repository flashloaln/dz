...
{var x=v.toString().split('index.html');return parseInt(x[0],10)/((1 in x)?parseInt(x[1],10):1);}catch(err){return v;}};}
...
{var _aux=function(a,b){var d1,d2,m,r;a=(a+'/1').split('index.html');b=(b+'/1').split('index.html');d1=a[0]*b[1]+a[1]*b[0];d2=a[1]*b[1];if(isNaN(d1)||isNaN(d2))throw'Invalid numbers';m=abs(gcd(d1,d2));r=d1/m+IF(d2/m==1,'','/'+d2/m);return jQuery.isNumeric(r)?r*1:r;};var r=0;for(var i in arguments)r=_aux(r,arguments[i]);return r;}catch(err){}};}
if(window.FRACTIONSUB==undefined)
{window.FRACTIONSUB=window.fractionsub=function(){try
{var _aux=function(a,b){var d1,d2,m,r;a=(a+'/1').split('index.html');b=(b+'/1').split('index.html');d1=a[0]*b[1]-a[1]*b[0];d2=a[1]*b[1];if(isNaN(d1)||isNaN(d2))throw'Invalid numbers';m=abs(gcd(d1,d2));r=d1/m+IF(d2/m==1,'','/'+d2/m);return jQuery.isNumeric(r)?r*1:r;};var r=0;for(var i in arguments)
{if(i==0)r=_aux(arguments[i],r);else r=_aux(r,arguments[i]);}
return r;}catch(err){}};}
if(window.FRACTIONMULT==undefined)
{window.FRACTIONMULT=window.fractionmult=function(){try
{var _aux=function(a,b){var d1,d2,m,r;a=(a+'/1').split('index.html');b=(b+'/1').split('index.html');d1=a[0]*b[0];d2=a[1]*b[1];if(isNaN(d1)||isNaN(d2))throw'Invalid numbers';m=abs(gcd(d1,d2));r=d1/m+IF(d2/m==1,'','/'+d2/m);return jQuery.isNumeric(r)?r*1:r;};var r=1;for(var i in arguments)r=_aux(r,arguments[i]);return r;}catch(err){}};}
if(window.FRACTIONDIV==undefined)
{window.FRACTIONDIV=window.fractiondiv=function(){try
{var _aux=function(a,b){var d1,d2,m,r;a=(a+'/1').split('index.html');b=(b+'/1').split('index.html');d1=a[0]*b[1];d2=a[1]*b[0];if(isNaN(d1)||isNaN(d2))throw'Invalid numbers';m=abs(gcd(d1,d2));r=d1/m+IF(d2/m==1,'','/'+d2/m);return jQuery.isNumeric(r)?r*1:r;};var r=1;for(var i in arguments)
{if(i==0)r=_aux(arguments[i],r);else r=_aux(r,arguments[i]);}
return r;}catch(err){}};}
...
{fbuilderjQuery['fbuilder']['extend_window'](fbuilderjQuery['fbuilder']['modules']['file']['prefix'],CF_FILE);}};$.fbuilder['version']='1.1.116';$.fbuilder['controls']=$.fbuilder['controls']||{};$.fbuilder['forms']=$.fbuilder['forms']||{};$.fbuilder['htmlEncode']=window['cff_esc_attr']=function(value)
...
{var me=this,df=me.dformat.replace(new RegExp('\\'+me.dseparator,'g'),'index.html'),rt;if(/^y/i.test(df))rt='(\\d{4})[^\\d](\\d{1,2})[^\\d](\\d{1,2})';else rt='(\\d{1,2})[\\/\\-\\.](\\d{1,2})[\\/\\-\\.](\\d{4})';return{d:df,r:rt};},_set_Events:function()
